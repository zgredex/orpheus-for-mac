...
Build its universal Apple Silicon and Intel slices with:
...
and records the complete per-architecture configure invocation in the generated
libraries before combining the slices. FFmpeg is
